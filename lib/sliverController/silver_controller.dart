...
import 'package:sliver_app_bar/data/data.dart';
import 'package:sliver_app_bar/model/my_header.dart';
import 'package:sliver_app_bar/model/product_category.dart';
...
class SliverScrollController extends GetxController {
  ...
  void onInit() {
    ...
    //! get value of index in double  categories
